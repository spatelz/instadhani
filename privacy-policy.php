...
<html lang="zxx">
    <head>
        ...
        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="assets/css/bootstrap.min.css.htm">
        <!-- Mean Menu CSS -->
        <link rel="stylesheet" href="assets/css/meanmenu.css">
        <!-- Box Icons CSS -->
        <link rel="stylesheet" href="assets/css/boxicons.min.css.htm">
        <!-- Owl Carousel JS -->
        <link rel="stylesheet" href="assets/css/owl.carousel.min.css.htm">
        <link rel="stylesheet" href="assets/css/owl.theme.default.min.css.htm">
        <!-- Animate CSS -->
        <link rel="stylesheet" href="assets/css/animate.min.css.htm">
        <!-- Flat Icons CSS -->
        <link rel="stylesheet" href="assets/fonts/flaticon.css">
        <!-- Odometer CSS -->
        <link rel="stylesheet" href="assets/css/odometer.min.css.htm">
        <!-- Nice Select CSS -->
        <link rel="stylesheet" href="assets/css/nice-select.min.css.htm">
        <!-- Popup CSS -->
        <link rel="stylesheet" href="assets/css/magnific-popup.min.css.htm">
        <!-- Style CSS -->
        ...
        <div class="rules-area ptb-100">
            <div class="container">
                ...
                <div class="rules-item">
                    <img src="assets/img/blog/blog-details1.jpg" alt="Rules">
                    <h3>Introduce</h3>
                            ...
                            <div class="footer-logo">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span>Email:</span>
                                        <a href="/cdn-cgi/l/email-protection#741c1118181b34121d1a1b1a5a171b19"><span class="__cf_email__" data-cfemail="f098959c9c9fb096999e9f9ede939f9d">[email&#160;protected]</span></a>
                                    </li>
                                    <li>

                    ...
                    <div class="left">
                        <ul>
                            <li>
                                ...
                                <a href="#">
                                    222,223 1st floor Raguleela Mall, Kandivali West, Mumbai
                                </a>
                            </li>
                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link dropdown-toggle">Services <i class="fa fa-caret-down" aria-hidden="true"></i>
                                </a>
                                <ul class="dropdown-menu">

                                    <li class="nav-item">
                                        <a href="loan.html" class="nav-link">Business Loan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="apply.html" class="nav-link">Personal Loan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="testimonials.html" class="nav-link">Home Loan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="team.html" class="nav-link">Credit Card</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="faq.html" class="nav-link">Working Capital</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="404.html" class="nav-link">Loan Against Property </a>
                                    </li>

                                </ul>
                            </li>
                            <li class="nav-item">
                                <a href="about.html" class="nav-link">Eligibility Calculator</a>
                            </li>
                            <li class="nav-item">
                                <a href="about.html" class="nav-link">Finance Astra </a>
                            </li>
        ...
        <div class="rules-area ptb-100">
            <div class="container">
                ...
                <div class="rules-item">
                    <img src="assets/img/projects/project-details1.jpg" alt="Rules">
                    <h3>Introduce</h3>
                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing words which don't look even slightly believable.</p>
                    ...
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting words which don't look even slightly believable.</p>
                </div>
                            ...
                            <div class="footer-logo">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span>Email:</span>
                                        <a href="/cdn-cgi/l/email-protection#224a474e4e4d62444b4c4d4c0c414d4f"><span class="__cf_email__" data-cfemail="4f272a2323200f2926212021612c2022">[email&#160;protected]</span></a>
                                    </li>
                                    <li>
